...
public class CameraPreview extends ViewGroup {
    ...
    private double widthMarginFraction = 0.08d;
    private double heightMarginFraction = 0.25d;
...
//        int margin = (int)Math.min(intersection.width() * widthMarginFraction, intersection.height() * heightMarginFraction);
//        if (intersection.height() > intersection.width()) {
//            // We don't want a frame that is taller than wide.
//            intersection.inset(0, (intersection.height() - intersection.width()) / 2);
//        }

        intersection.inset((int)(intersection.width() * widthMarginFraction), (int)(intersection.height() * heightMarginFraction));
        return intersection;
    }
