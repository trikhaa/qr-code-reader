...
public class ViewfinderView extends View {
    ...
    protected static final int CURRENT_POINT_OPACITY = 0xCC;
    ...
    protected boolean displayDots;
    protected boolean drawInnerSquare;
    protected int innerSquareMargin;
    protected int innerSquareCorner;
    protected int innerSquareThickness = 1;
    protected int innerSquareColor = Color.WHITE;
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        this.laserVisibility = attributes.getBoolean(R.styleable.zxing_finder_zxing_viewfinder_laser_visibility,
                true);
        this.displayDots = attributes.getBoolean(R.styleable.zxing_finder_zxing_viewfinder_possible_points_visibility,
                true);
...
//        canvas.drawRect(0, frame.bottom + 1, width, height, paint);
        ...
        //Start - Outside mask with a hole
        paint.setColor(resultBitmap != null ? resultColor : maskColor);
        ...
        canvas.drawRoundRect(rectF, innerSquareCorner, innerSquareCorner, transPaint);

        // Start - Inside rounded Square - Ashish
        if (drawInnerSquare) {
            Paint borderPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
            borderPaint.setColor(innerSquareColor);
            borderPaint.setStyle(Paint.Style.STROKE);
            borderPaint.setStrokeWidth(innerSquareThickness);
            RectF rf = new RectF(frame.left + innerSquareMargin, frame.top + innerSquareMargin, frame.right - innerSquareMargin, frame.bottom - innerSquareMargin);
            canvas.drawRoundRect(rf, innerSquareCorner, innerSquareCorner, borderPaint);
        }
    ...
    public void setPossiblePointsVisibility(boolean visible) {
        this.displayDots = visible;
    }

    public void showInnerSquare(int margin, int corner, int thickness, int color) {
        this.drawInnerSquare = true;
        this.innerSquareMargin = margin;
        this.innerSquareCorner = corner;
        this.innerSquareThickness = thickness;
        this.innerSquareColor = color;
    }
}
